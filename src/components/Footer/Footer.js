            ...
            <footer>
                ...
                <div className="contactsLink" id="about">
                    <div className="contacts">
                        <div><img className="footerImgMail" src={require("../media/icons/mail.svg")} alt="mail"/>
                            <span>work.of.future@gmail.com</span></div>
                        <div><img className="footerImgPhone" src={require("../media/icons/phone.svg")} alt="phone"/><span>+38 (050) 789 24 98</span>
                        </div>
                        <div><img className="footerImgMobile" src={require("../media/icons/cellphone.svg")} alt="cellphone"/><span>+38 (095) 556 08 45</span>
                        </div>
                    </div>
                    <div className="link1">
                        <ul>
                ...
                <div className="social">
                    ...
                    <div className="socialIconShell">
                        <a className="socialIcon" href="#">
                            <svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsxink="http://www.w3.org/1999/xlink">
                                <title>facebook</title>
                                <desc>Created with Sketch.</desc>
                                <defs></defs>
                                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    <g className="hover-color-svg" id="facebook" fill="#FFFFFF" fillRule="nonzero">
                        ...
                        <a className="socialIcon" href="#">
                            <svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsxink="http://www.w3.org/1999/xlink">
                                ...
                                <defs></defs>
                                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    <g className="hover-color-svg" id="linkedin" fill="#FFFFFF" fillRule="nonzero">
                        ...
                        <a className="socialIcon" href="#">
                            <svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsxink="http://www.w3.org/1999/xlink">
                                ...
                                <defs></defs>
                                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    <g className="hover-color-svg"  id="instagram" fill="#FFFFFF" fillRule="nonzero">
                        ...
                        <a className="socialIcon" href="#">
                            <svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsxink="http://www.w3.org/1999/xlink">
                                ...
                                <defs></defs>
                                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    <g className="hover-color-svg"  id="twitter" fill="#FFFFFF" fillRule="nonzero">
                        ...
                        <a className="socialIcon" href="#">
                            <svg width="26px" height="26px" viewBox="0 0 26 26" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsxink="http://www.w3.org/1999/xlink">
                                ...
                                <defs></defs>
                                <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                    <g className="hover-color-svg" id="pinterest" fill="#FFFFFF" fillRule="nonzero">
